<footer class="footer">
   <div class="container">
      <div class="footer__inner">
         <div class="footer__item footer__item-between">
         ...
         <div class="footer__item">
            <ul class="footer__list">
               ...
               <ul class="header-top__soc footer__soc">
                  ...
                  <li class="soc__item">
                     <a href="#" class="soc__link">
                        <img src="/wp-content/themes/aeromir/img/soc/viber.svg" alt="" class="soc__img footer__soc-img">
                     </a>
                  </li>
                  <li class="soc__item">
                     <a href="#" class="soc__link">
                        <img src="/wp-content/themes/aeromir/img/soc/whatsapp.svg" alt="" class="soc__img footer__soc-img">
                     </a>
                  </li>
               </ul>
            </ul>
...
<link rel="stylesheet" href="/wp-content/themes/aeromir/css/main.min.css">
